    ...
    sections: [
      {
        ...
        items: [
          ...
          { label: "Height", value: "5 feet 4 inches (163 cm)" },
        ...
        groups: [
          {
            items: [
              ...
              "CTET — Qualified",
              "STET — Qualified",
              "M.A. — Pursuing from Patna (final in May 2026)",
            ],
          },
        ],
      },
    ...
    sections: [
      {
        ...
        items: [
          ...
          { label: "ऊँचाई", value: "5 फीट 4 इंच (163 सेमी)" },
        ...
        groups: [
          {
            items: [
              ...
              "CTET — उत्तीर्ण",
              "STET — उत्तीर्ण",
              "एम.ए. — पटना से अध्ययनरत (मई 2026 में पूर्ण)",
            ],
          },
        ],
      },
