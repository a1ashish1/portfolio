    ...
    sections: [
        ...
        groups: [
          {
            items: [
              ...
              "Consistently ranked 1st throughout primary schooling",
              "Relocated to Bihar in 2007 after mother received a government posting",
              "Briefly attended a boarding school in Darbhanga",
              "Selected for Jawahar Navodaya Vidyalaya (JNV)",
              "Completed Matriculation from JNV Darbhanga (2014) with 10 CGPA",
              "Consistently maintained a Top 2 rank",
        ...
        groups: [
          {
            items: [
              ...
              "Showed resilience through a profound personal loss — father passed away in November 2010",
            ],
          },
        ],
      },
        ...
        groups: [
          {
            ...
            items: [
              ...
              "Achieved multiple All India Rank 1 in Physics",
              "Secured single-digit ranks in Mathematics and Physics",
          ...
          },
          {
            ...
            items: [
              "JEE Mains — AIR ~1,300",
              "JEE Advanced — AIR ~7,000",
              "VIT / SRM — AIR under 500",
            ],
          },
        ],
      },
        ...
        groups: [
          {
            items: [
              ...
              "Highspot — Software Engineer (~1.8 years)",
      ...
      },
      {
        ...
        items: [
          ...
          {
            label: "Mother",
            value: "Government school teacher (Classes 5–10)",
          },
          {
            label: "Sister",
            value:
    ...
    sections: [
        ...
        groups: [
          {
            items: [
              ...
              "एक गहन व्यक्तिगत क्षति के बावजूद दृढ़ता दिखाई — नवंबर 2010 में पिताजी का निधन",
            ],
          },
        ],
      },
        ...
        groups: [
          {
            ...
            items: [
              ...
              "भौतिकी में कई बार अखिल भारतीय रैंक 1 प्राप्त",
              "गणित एवं भौतिकी में एकल अंकीय रैंक",
        ...
        groups: [
          {
            items: [
              ...
              "Highspot — सॉफ्टवेयर इंजीनियर (लगभग 1.8 वर्ष)",
      ...
      },
      {
        ...
        items: [
          ...
          {
            label: "माँ",
            value: "सरकारी विद्यालय में शिक्षिका (कक्षा 5–10)",
          },
          {
            label: "बहन",
            value:
